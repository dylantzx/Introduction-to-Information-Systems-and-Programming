 ...
 */
package com.example.problemset2b.midi;
...
public class Midi {
    ...
    public final static com.example.problemset2b.midi.Instrument DEFAULT_INSTRUMENT = Instrument.PIANO;

    // active MIDI channels, assigned to instruments
    private final Map<com.example.problemset2b.midi.Instrument, MidiChannel> channels = new HashMap<com.example.problemset2b.midi.Instrument,MidiChannel>();
     ...
     */
    public void play(int note, int duration, com.example.problemset2b.midi.Instrument instr) {
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void beginNote(int note, com.example.problemset2b.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
            channel.noteOn(note, VELOCITY);
        }
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void endNote(int note, com.example.problemset2b.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
     ...
     */
    private void log(int note, com.example.problemset2b.midi.Instrument instr, boolean isNoteOn) {
     ...
     * modifies this
     */
    private MidiChannel getChannel(com.example.problemset2b.midi.Instrument instr) {
     ...
     * @param instr
     */
    private void patchInstrumentIntoChannel(MidiChannel channel, com.example.problemset2b.midi.Instrument instr) {
